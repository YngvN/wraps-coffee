...
server/             # Optional local LAN sync server (Node, run via tsx)
  ...
  assistant/         # AI assistant: entity registry + per-entity adapters (types.ts, registry.ts, steps.ts, client.ts, entities/)
