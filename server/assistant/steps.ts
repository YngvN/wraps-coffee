...
const ENTITY_DESCRIPTIONS: Record<string, string> = {
  ...
  printer: "a receipt printer the order boards print to (Settings → Printers) — adding one by IP address or print queue, renaming it, its paper width, or which one is the default",
...
const ENTITY_KEYWORDS: Partial<Record<string, { no: string[]; en: string[] }>> = {
  ...
  printer: { no: ['skriver', 'skrivere', 'kvitteringsskriver'], en: ['printer', 'printers', 'receipt printer'] },
