...
/**
 * Official Yr logo (hex #00B9F1), rendered from vector path data sourced
 * from the `simple-icons` package (CC0). Shared between the admin
 * Integrations page and a kiosk weather slide's own branded-theme logo (see
 * `WeatherSlide`'s `useBrandTheme`).
 */
export function YrLogo(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="#00B9F1" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true" {...props}>
