...
/** The mDNS name a store's screens advertise, derived from its own name (see `StoreSettings.name`) rather than a separately typed field — e.g. `"ADHDisplay"` → `"adhdisplay-screen"`, shown as `<name>.local`. */
