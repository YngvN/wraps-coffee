...
/** Effective background image for a specific piece of content: its own (`useOwnBackgroundImage`) when set, else `fallback` — typically the content's slot's own image. */
