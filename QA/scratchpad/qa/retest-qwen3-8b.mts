// Fresh-session-per-scenario re-run of assistant-qa-report-normistral-2026-08-03.md's A.1-C.9b,
// against qwen3:8b (thinking) / qwen2.5vl:3b (vision) instead of normistral-it:7b. See
// QA/Reports/qa-test-plan-qwen3-8b-2026-08-03.md for the full classification/reasoning behind every
// newChat() call below — this script is that plan's own execution, not a fresh design.
